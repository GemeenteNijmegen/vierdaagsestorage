...
import { StorageStage as StorageStage } from './StorageStage';
...
export class PipelineStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    pipeline.addStage(new StorageStage(this, 'vierdaagse', {
  ...
  private connectionSource(connectionArn: CfnParameter): pipelines.CodePipelineSource {
    return pipelines.CodePipelineSource.connection(`GemeenteNijmegen/${Statics.projectName}`, this.branchName, {
